...
\urlstyle{same}
\hypersetup{
  pdftitle={First version control project},
  pdfauthor={Shaela Noble},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{First version control project}
\author{Shaela Noble}
\date{2025-03-26}
...
I am learning to use Git and Github for version control on an RStudio
project. I am modifying this file, staging and committing changes, and
...
\includegraphics{firstversionproj_files/figure-latex/test-plot-1.pdf}
